...
public class ControlCategoria extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String NombreCate=request.getParameter("txtnomCate");
        Categorias ca=new Categorias();
        ca.setCodigoCate(codigo);
        ca.setNombreCate(NombreCate);
        
        if(action.equalsIgnoreCase("Registrar")){

        if (DaoCategorias.registrarCategorias(ca)){
        ...
        request.getRequestDispatcher("RegistrarCategoria.jsp").forward(request, response);
            ...
            if(DaoCategorias.actualizarcategorias(ca)){
        ...
        request.getRequestDispatcher("RegistrarCategoria.jsp").forward(request, response);
            ...
            if(DaoCategorias.eliminarcategorias(ca)){
